  ...
  return (
    <div onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}
      className="w-full border border-raisin-black rounded-xl shadow-place transition-shadow relative flex items-center justify-center flex-col">
        ...
        {
        visible && 
        <button className="h-20 w-20 rounded-full bg-[rgba(0,0,0,0.5)] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-linen flex items-center justify-center"
