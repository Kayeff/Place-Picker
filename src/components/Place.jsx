...
export default function Place({ place, onClick, Icon }) {
  ...
  return (
    <div
      ...
      className="w-full rounded-xl shadow-place transition-shadow relative flex items-center justify-center flex-col"
    >
      <img
        ...
        alt={place.image.alt}
      />
      <p className="font-medium p-1 tracking-tight rounded-b-xl">
        {place.title}
      </p>
      {visible && (
        <button
